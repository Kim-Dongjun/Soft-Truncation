...
def load_dataset_stats(config, assetdir, mode=''):
  ...
  if config.data.dataset == 'CIFAR10':
    ...
    filename = assetdir + f'/FFHQ_{config.data.image_size}_{mode}_stats.npz'
  elif config.data.dataset == 'CelebAHQ':
    filename = assetdir + f'/CelebAHQ_{config.data.image_size}_{mode}_stats.npz'
  else:
